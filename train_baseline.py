...
class Trainer:
    ...
    def __init__(self, model, train_loader, val_loader, config):
        ...
        # tensorboard
        self.writer = SummaryWriter(f"logs/baseline_{time.strftime('%Y%m%d_%H%M%S')}")
    ...
    def train(self):
        ...
        for epoch in range(self.config['num_epochs']):
            ...
            if epoch > 10 and val_acc < self.best_val_acc - 5:
...
def main():
    ...
    # create model
    print("\nInitializing model...")
    model = BaselineCNN(num_classes=7, dropout_rate=0.5)
