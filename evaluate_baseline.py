...
Generates performance metrics and confusion matrix.
"""
...
class ModelEvaluator:
    ...
    def __init__(self, model_path, test_loader):
        ...
        self.model = BaselineCNN(num_classes=7)
    ...
    def plot_per_class_accuracy(self, report, save_path='results/per_class_accuracy.png'):
    ...
    def save_results(self, accuracy, report, save_path='results/baseline_metrics.json'):
...
def main():
    ...
    # evaluate
    evaluator = ModelEvaluator(model_path, test_loader)
    evaluator.evaluate()
